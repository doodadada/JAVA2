...
class Dclass{
	...
	public Dclass(int n1, int n2) {
		// Dclass(n1); 생성자가 호출되므로 객체가 더 생길수도 있습니다. 현재위치는 생성자를 호출할 수 있는 위치X
		this(n1); //객체 생성은 안하고 형제생성자의 코드만 실행하겠다는 호출
		this.num2=n2;
		
	}
	public Dclass(int n1, int n2, int n3) {
		this(n1,n2); 
		this.num3=n3; 
	}
