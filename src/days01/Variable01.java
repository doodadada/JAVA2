...
// 자체 실행 여부에 따라 public void main(){}를 포함하고 있습니다.

public class Variable01 {

	public static void main(String[] args) {
		
		Scores std1 = new Scores(); //std1 : 참조변소 new Scores() : 인스턴스
			// new Scores() 에 의해서 Heap 영역에 필요한 만큼 메모리를 확보하고 그 주소를 참조변수 std1에 전달합니다
		
		//String str = "Korea"
		String str = new String("Korea");
		
		System.out.println("겁나 쉬운 자바프로그램");
		// Ctrl + f11 : run 단축키
		// Ctrl + Alt + 방향키 위 or 아래 : 한줄 혹은 드래그한 부분 복사
		int[] kor = new int[5];
		int[] eng = new int[5];
		int[] mat = new int[5];
		int[] tot = new int[5];
		...
		System.out.println("------------------------------------------------------------");
		//Alt+방향키 위or아래 : 해당 줄 혹은 구문 위 아래로 이동
		...
		//위 문장은 참조변수 배열을 생성한거지, Scores 객체가 만들어진게 아닙니다.
		
		//각각의 참조변수에 새로운 인스턴스를 할당해야 화용이 가능합니다
		std[0] = new Scores();
		std[1] = new Scores();
		std[2] = new Scores();
