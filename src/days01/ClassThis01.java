...
// 멤버변수는 new생성자()에 의해 새로운 공간 객체별로 각각 만들어집니다.
...
public class ClassThis01 {
	public static void main(String[] args) {
		...
		c2.init(20); // 20 -> init 메서드의 매개변수 n c2은 init 메서드의 this로 전달
		c3.init(30); // 30 -> init 메서드의 매개변수 n c3은 init 메서드의 this로 전달

		// Cclass c4 = c3; //참조값의 복사(얕은복사)
		// c3.setNum(100);
