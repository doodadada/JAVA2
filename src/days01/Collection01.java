...
// 리스트 클래스를 상속받은 ArrayList, Vector의 사용비녿수가 가장 높습니다
...
public class Collection01 {
	public static void main(String[] args) {
		...
		// Vector 와 ArrayList 저장은 int 형이 아닌 Integer 형 데이터(객체)가 저장됩니다.

		// ArrayList 안에 add 멤버 메서드가 존재하고 그 메서드를 통해 데이터를 저장
		//a.add("abc");
		//v.add("abc");
		// add 메서드의 매개변수는 Object 인 것을 예상할 수 있습니다.
		// public void add(Object item){}

		a.get(0);
		for (int i = 0; i < v.size(); i++) {
			int b = (Integer) v.get(i); // 부모자식 구조에서만 가능 Integer-Object 관계라 가능
