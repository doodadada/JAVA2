...
public class Collection04 {
	public static void main(String[] args) {
		...
		// 키값은 중복된 값으로 두개의 키 값이 저장되지 않습니다
		// 저장된 데이터들을 서로 구분하기 위해

		System.out.printf("HashMap 1 = > \"%s\"\n", hm.get(1));
		hm.put(1, "First");
		System.out.printf("HashMap 1 = > \"%s\"\n", hm.get(1));
		// 같은 키값으로 다른 Value 를 정하면, 기존 Value 가 지워지고 새ㅗㄹ운 Value 로 대체됩니다.
		
		// Value 값은 다른 Key 값에 얼마든지 중복되어 저장될 수 있습니다.
		hm.put(1, "First");
		hm.put(2, "First");
		hm.put(3, "First");
		
		// 제네릭이 지정된 ArrayList 에 아무 데이터나 다 저장하려면
